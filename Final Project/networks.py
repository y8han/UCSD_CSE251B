...
class GANLoss(nn.Module):
    ...
    def __init__(self, gan_mode, target_real_label=1.0, target_fake_label=0.0):
        ...
        self.register_buffer('real_label', torch.tensor(target_real_label).to("cuda"))
        self.register_buffer('fake_label', torch.tensor(target_fake_label).to("cuda"))
        self.gan_mode = gan_mode
        if gan_mode == 'lsgan':
            self.loss = nn.MSELoss()  # MSE loss error
